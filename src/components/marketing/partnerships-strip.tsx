    ...
    >
      <div className="route-padding-x mx-auto flex max-w-7xl flex-col gap-6 py-8 lg:flex-row lg:items-center lg:justify-between">
        ...
        <div className="flex flex-1 flex-wrap items-center gap-3 lg:justify-end">
          <Link
            className="flex min-h-14 items-center gap-3 rounded-2xl border border-white/10 bg-neutral-950 px-5 text-sm font-black tracking-widest text-white transition-colors hover:border-primary"
            href="/partnerships#1st-phorm"
          >
            1ST PHORM
            <IconArrowUpRight aria-hidden className="size-4 text-primary" />
          </Link>
          <Link
            className="flex min-h-14 items-center gap-3 rounded-2xl border border-white/10 bg-neutral-950 px-5 text-sm font-black tracking-widest text-white transition-colors hover:border-primary"
          ...
          <Link
            className="inline-flex min-h-14 items-center gap-2 px-2 text-sm font-bold text-primary hover:text-primary"
            href="/partnerships"
          >
            View all
