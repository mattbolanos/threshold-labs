  ...
  return (
    <section className="relative overflow-hidden pt-16 sm:pt-24">
      ...
      <MarketingContainer className="route-padding-x relative">
        <div className="grid items-center gap-10 lg:grid-cols-2 lg:gap-14">
          <div>
            ...
            <div className="mt-8 flex flex-wrap gap-3">
              ...
              <a
                className="inline-flex items-center gap-2 rounded-full border border-primary/25 bg-neutral-900/70 px-5 py-3 text-sm font-bold text-white transition-colors hover:border-primary"
          ...
          <div className="relative aspect-4/3 overflow-hidden rounded-3xl border border-primary/20 bg-neutral-900 shadow-2xl">
            <Image
        ...
        <div className="mt-12 grid grid-cols-2 overflow-hidden rounded-2xl border border-primary/15 bg-neutral-950/80 sm:grid-cols-4">
          {stats.map((stat) => (
            <div
              className="border-r border-b border-primary/10 p-4 last:border-r-0 sm:border-b-0 sm:p-5"
              key={stat.label}
            >
